...
if($insert_query){
    ...
    $display_message = "failed to insert product";
}
...
<section>
    ...
    <!-- enctype="multipart/form-data is used to insert images into database -->
    <form action="" class="add_product" method="post" enctype="multipart/form-data">

<input type="text" name="product_name" placeholder="Enter product name" class="input_fields" required>
<input type="number" name="product_price" placeholder="Enter product price" min="0" class="input_fields" required>
<input type="file" name="product_image" class="input_fields" accept="image/png, image/jpg, image/jpeg, image/AVIF" required>
